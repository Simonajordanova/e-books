...
This is the backend for my E-books shop project, made for the UIKTP course at FCSE. It's a REST API built with Spring Boot. The frontend is in a separate repo: https://github.com/Simonajordanova/uikt-main-frontend
